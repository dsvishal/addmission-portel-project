...
//setUp
cloudinary.config({
    cloud_name: "dondkpd1t",
    api_key: "267975795434385",
    api_secret: "Up9dIc4QSy_-07oYYpB6LZUHCNo",
});
...
class FrontController {
    ...
    static contect = async (req, res) => {
        try {
            ...
            res.render("contect", { n: name, i: image, e: email, message: req.flash("success"), msg: req.flash("error") })
        } catch (error) {
            console.log(error)
        }
    }
    ...
    static sendVerifymail = async (name, email, user_id) => {
        ...
        let info = await transporter.sendMail({
          ...
          html:
            "<p>Hii " +
            name +
            ',Please click here to <a href="https://addmission-portel-project.onrender.com/verify?id=' +
            user_id +
    ...
    static sendEmail = async (name, email, token) => {
        ...
        let info = await transporter.sendMail({
            ...
            html:
                "<p>Hii " +
                name +
                ',Please click here to <a href="https://addmission-portel-project.onrender.com/reset-password?token=' +
                token +
